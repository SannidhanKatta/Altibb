...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#001233] overflow-hidden w-full">
      {/* Hero Section */}
      <section className="flex relative justify-center items-center w-full min-h-screen text-white">
      ...
      <section className="relative z-10 bg-[#001233] w-full">
        <ForestIllustration />
      ...
      <section className="bg-[#F5F7FA] w-full">
        <div className="relative z-20 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex flex-col gap-8 py-12 lg:flex-row lg:gap-12 sm:py-16 lg:py-24">
            ...
            >
              <div className="bg-[#E8EDF3] p-6 sm:p-8 rounded-lg lg:sticky lg:top-24">
                <img
                  src="/vr-man.png"
      ...
      <section className="relative bg-[#001F1B] text-white min-h-screen w-full">
        {/* Background Image */}
      ...
      <section className="py-12 w-full bg-white sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="relative w-full bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true, amount: 0.3 }}
            className="relative h-[600px] bg-[#001F4D] overflow-hidden"
          >
            <motion.img
              initial={{ scale: 1.05 }}
              whileInView={{ scale: 1 }}
